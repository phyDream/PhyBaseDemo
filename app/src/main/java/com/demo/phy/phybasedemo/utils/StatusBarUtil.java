...
public class StatusBarUtil {
     ...
     * @return 1:MIUUI 2:Flyme 3:android6.0
     */
    public static int StatusBarBlackMode(Activity activity, int fontColor) {
        int result = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                setStatusBarColor(activity, fontColor);
            }
        }
        return result;
    }
     ...
     * 设置状态栏颜色
     */
    public static void setStatusBarColorAndFontColor(Activity activity, int statusBarColor) {
